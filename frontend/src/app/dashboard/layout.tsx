...
import { Home, Building, FileText, Calendar, CheckSquare, Mail } from 'lucide-react';
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="inline-flex items-center justify-center rounded-md bg-red-600 px-3.5 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                type="button"
